...
public class CountingGame
{
    ...
    public static void main(String args[])
    {
        ...
        //taking the no of player from user
   ...
   public static int doRhyme(ListInterface<Integer> players, ListInterface<String> rhyme, int startAt)
    {
	   	...
	   	for(i=1;i<=size;i++)
	   	{
	   			...
	   			//if the j exceed no of players start from the first player
	   			if(j>players.getLength())
	   			{
	   				j=1;
	   			}
	   	...
	   	j--;
	   	//if j become zero than go to last player
	   	if(j<1)
	   		j=players.getLength();
